...
ldamodel = LdaModel(corpus, num_topics = 45, id2word = dictionary, iterations = 100, passes = 10, alpha = 'asymmetric')
ldamodel.save("haberlerTopic.model")

#pyLDAvis grafik çizimi
if __name__ == '__main__':
    data = pyLDAvis.gensim.prepare(ldamodel, corpus, dictionary, mds='mmds')
    pyLDAvis.save_html(data, 'haberlerLda.html')
